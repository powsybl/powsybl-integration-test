...
public final class LoadFlowIntegrationTest {
    ...
    static void compareResults(LoadFlowResult test, LoadFlowResult reference) {
    ...
    static Network loadNetworkReference(String networkResourceName, String parameterType) {
    ...
    static LoadFlowResult loadResultReference(String networkResourceName, String parameterType) {
        try {
    ...
    static <T> void assertAndLog(T value, T reference, String differenceInfo) {
        if (value != reference) {
            detectedDifferences.add(String.format(differenceInfo + " value is %s, ref is %s.", value, reference));
        }
    }

    static void assertAndLog(double value, double reference, double delta, String differenceInfo) {
    ...
    static void assertAndLog(String value, String reference, String differenceInfo) {

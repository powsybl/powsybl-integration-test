...
public final class SampleUtils {
    ...
    /**
     * As an input, there is a map where the key is a class, and the value associated is the list of all elements of this class.
     ...
     * @return A map similar to the input, except that the associated list of elements is a reduced set (as it is a sample).
     */
    public static <T> Map<String, Set<T>> createSamples(Map<String, List<T>> elementsList, Map<String, Double> rates, Random r) {
        Map<String, Set<T>> sample = new HashMap<>();
